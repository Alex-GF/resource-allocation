# Pricing-Driven Service Allocation for Edge Computing

This repository contains the implementation used to study pricing-driven service placement over geographically distributed edge resources. The workflow generates topology-specific pricing models, creates constrained problem instances, and delegates optimization to PRIME through its REST API.
